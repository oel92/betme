...
//        String key = myIntent.getStringExtra("key");
       ...
       // final ArrayList<String> images = new ArrayList<String>();
        ...
        client.post("betme-os.appspot.com/ViewBet", params, new AsyncHttpResponseHandler() {
...
//       String key = myIntent.getStringExtra("key");
      ...
      // final ArrayList<String> images = new ArrayList<String>();
       AsyncHttpClient client = new AsyncHttpClient();
       client.get("betme-os.appspot.com/ViewBet", params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
           	String str;
				try {
					...
					JSONObject jsonPicture1 = dict.getJSONObject("picture1");
					JSONObject jsonPicture2 = dict.getJSONObject("picture2");
					...
					person1 = jsonPerson1.toString();
					person2 = jsonPerson2.toString();
					personPic1 = jsonPicture1.toString();
					personPic2 = jsonPicture2.toString();
					team1 = jsonTeam1.toString();
					team2 = jsonTeam2.toString();
					date = jsonDate.toString();
					terms = jsonTerms.toString();
